...
class Menu:
    def __init__(self, screen, screen_width, screen_height, background_image, font, title_font, button_sound, select_sound):
        ...
        self.font = pygame.font.Font(resource_path("Assets\Interface\main_font.ttf"), 40)
        self.title_font = pygame.font.Font(resource_path("Assets\Interface\main_font.ttf"), 60)
