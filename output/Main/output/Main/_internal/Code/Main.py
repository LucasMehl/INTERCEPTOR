...
# MENU ASSETS
menu_bg = pygame.transform.scale(pygame.image.load(resource_path("Base/Assets/Background/Bkg2.png")).convert(), (Screen_Width, Screen_Height))
...
background = pygame.transform.scale(pygame.image.load(resource_path("Base/Assets/Background/Bkg2.png")).convert(), (Screen_Width, Screen_Height))
cursor = pygame.transform.scale(pygame.image.load(resource_path("Base/Assets/Interface/crosshair.png")).convert_alpha(), (20, 20))
