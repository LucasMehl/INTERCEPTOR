...
# MENU ASSETS
menu_bg = pygame.transform.scale(pygame.image.load(resource_path("Assets/Background/Bkg2.png")).convert(), (Screen_Width, Screen_Height))
menu_font = pygame.font.Font(None, 48)
menu_title_font = pygame.font.Font(None, 72)
button_sound = pygame.mixer.Sound(resource_path("Assets/game_sounds/UI_buttons.ogg"))
button_sound.set_volume(0.5)
select_sound = pygame.mixer.Sound(resource_path("Assets/game_sounds/UI_buttons.ogg"))
...
background = pygame.transform.scale(pygame.image.load(resource_path("Assets/Background/Bkg2.png")).convert(), (Screen_Width, Screen_Height))
cursor = pygame.transform.scale(pygame.image.load(resource_path("Assets/Interface/crosshair.png")).convert_alpha(), (20, 20))
